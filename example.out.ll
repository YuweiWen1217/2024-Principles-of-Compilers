...
L77:  ;
    ...
    %r201 = load i32, ptr %r192
    store i32 %r201, ptr %r200
...
L82:  ;
    ...
    store i32 %r240, ptr %r239
    %r242 = add i32 0,0
    store i32 %r242, ptr %r241
    %r243 = load i32, ptr @i
...
L90:  ;
    %r247 = load i32, ptr %r237
    %r248 = load i32, ptr %r239
    %r249 = add i32 %r247,%r248
    store i32 %r249, ptr %r241
    br label %L91
L91:  ;
    %r250 = load i32, ptr @i
...
L92:  ;
    %r254 = load i32, ptr %r239
    %r255 = load i32, ptr %r237
    %r256 = sub i32 %r254,%r255
    store i32 %r256, ptr %r241
    br label %L93
L93:  ;
    %r257 = load i32, ptr @i
...
L94:  ;
    %r261 = load i32, ptr %r237
    %r262 = load i32, ptr %r239
    %r263 = mul i32 %r261,%r262
    store i32 %r263, ptr %r241
    br label %L95
L95:  ;
    %r264 = load i32, ptr @i
...
L96:  ;
    %r268 = load i32, ptr %r239
    %r269 = load i32, ptr %r237
    %r270 = sdiv i32 %r268,%r269
    store i32 %r270, ptr %r241
    br label %L97
L97:  ;
    %r271 = load i32, ptr @i
...
L98:  ;
    %r275 = load i32, ptr %r239
    %r276 = load i32, ptr %r237
    %r277 = srem i32 %r275,%r276
    store i32 %r277, ptr %r241
    br label %L99
L99:  ;
    %r278 = load i32, ptr @i
...
L100:  ;
    %r282 = load i32, ptr %r239
    %r283 = load i32, ptr %r237
    %r284 = call i32 @power(i32 %r282,i32 %r283)
    store i32 %r284, ptr %r241
    br label %L101
L101:  ;
    %r285 = load i32, ptr %r241
    call void @intpush(i32 %r285)
    br label %L84
L102:  ;
    %r290 = load i32, ptr @i
